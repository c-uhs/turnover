...
% paper:
\newcommand{\xh}{$x_1$}\newcommand{\xm}{$x_2$}\newcommand{\xl}{$x_3$}\newcommand{\arrowlabel}[1]{\small{#1}}\newcommand{\opa}{1}
...
% input nodes (no tbox)
\node(i1) [tbox=\colore, left = \dx of x1, opacity=\opa] {\nodelabel{$e_1$}};
\node(i2) [tbox=\colore, left = \dx of x2, opacity=\opa] {\nodelabel{$e_2$}};
\node(i3) [tbox=\colore, left = \dx of x3, opacity=\opa] {\nodelabel{$e_3$}};
% output nodes (no tbox)
\node(o1) [tbox=\colore, right = \dx of x1, opacity=0] {}; %{\nodelabel{$o_3$}};
\node(o2) [tbox=\colore, right = \dx of x2, opacity=0] {}; %{\nodelabel{$o_3$}};
\node(o3) [tbox=\colore, right = \dx of x3, opacity=0] {}; %{\nodelabel{$o_3$}};
% arrows ---------------------------------------------------------------------------------------
% entry
...
% turnover
\draw[arrow=\colort] (x1) edge["\arrowlabel{$\phi_{12}$}", bend left=25] (x2); 
\draw[arrow=\colort] (x2) edge["\arrowlabel{$\phi_{21}$}", bend left=25] (x1);
\draw[arrow=\colort] (x3) edge["\arrowlabel{$\phi_{32}$}", bend left=25] (x2); 
\draw[arrow=\colort] (x2) edge["\arrowlabel{$\phi_{23}$}", bend left=25] (x3);
