...
% input nodes (no tbox)
\node(i1) [left = \dx of x1, opacity=0] {}; %{\nodelabel{$e_1$}};
\node(i2) [left = \dx of x2, opacity=0] {}; %{\nodelabel{$e_2$}};
\node(i3) [left = \dx of x3, opacity=0] {}; %{\nodelabel{$e_3$}};
% output nodes (no tbox)
\node(o1) [right = \dx of x1, opacity=0] {}; %{\nodelabel{$o_3$}};
\node(o2) [right = \dx of x2, opacity=0] {}; %{\nodelabel{$o_3$}};
\node(o3) [right = \dx of x3, opacity=0] {}; %{\nodelabel{$o_3$}};
% arrows ---------------------------------------------------------------------------------------
% entry
