...
% input nodes (no tbox)
\node(i1) [tbox=\colore, left = 2cm of x1] {}; %{\nodelabel{$e_1$}};
\node(i2) [tbox=\colore, left = 2cm of x2] {}; %{\nodelabel{$e_2$}};
\node(i3) [tbox=\colore, left = 2cm of x3] {}; %{\nodelabel{$e_3$}};
% output nodes (no tbox)
\node(o1) [tbox=\colore, right = 2cm of x1] {}; %{\nodelabel{$o_3$}};
\node(o2) [tbox=\colore, right = 2cm of x2] {}; %{\nodelabel{$o_3$}};=
\node(o3) [tbox=\colore, right = 2cm of x3] {}; %{\nodelabel{$o_3$}};
% arrows ---------------------------------------------------------------------------------------
% entry
...
% legend ---------------------------------------------------------------------------------------
\node(l1) [text width = 1.5cm, align=left] at (-1.6cm,-5cm)   {\footnotesize Births};
