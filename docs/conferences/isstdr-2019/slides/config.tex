\usepackage{graphicx,tikz,tikz-qtree,array,subcaption,caption}
\usepackage{bm,amsmath}
\usepackage{hyperref,xpatch,listings}
\usepackage{multirow,booktabs}
\usepackage[export]{adjustbox}
\usepackage[backend=bibtex,style=numeric,maxcitenames=1,sorting=none,
            isbn=false,url=true,doi=false,eprint=false]{biblatex}
% package configuration
\graphicspath{{figs/}{figs/logos/}}
...
% styling
\input{style.tex}
\input{figs/risk-turnover.tex}
\input{figs/flows.tex}
% tex commands
