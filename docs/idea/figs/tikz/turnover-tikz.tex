...
\draw[arrow=purple] (i1) edge["$\zeta_{12}$", swap, bend right=20] (i2); 
\draw[arrow=purple] (i2) edge["$\zeta_{21}$", swap, bend right=20] (i1);
\draw[arrow=purple] (i3) edge["$\zeta_{32}$", swap, bend right=20] (i2); 
\draw[arrow=purple] (i2) edge["$\zeta_{23}$", swap, bend right=20] (i3);
\draw[arrow=purple] (i1) edge["$\zeta_{13}$", swap, bend right=55, near end] (i3); 
\draw[arrow=purple] (i3) edge["$\zeta_{31}$", swap, bend right=55, near end] (i1);
