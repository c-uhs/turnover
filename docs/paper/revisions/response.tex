...
\reply{%
  ...
  So, we've replaced the phrase ``herd immunity'' with ``\added{herd effect}'' throughout the paper.
  However, herd effect underpins one of the three key phenomena explored in the paper,
  and notably it relies on the existence of a treated/immune group,
  as distinguished from herd effects associated with high infection prevalence
  (partnerships between two infectious individuals resulting in no transmission).
  Specifically, it is not possible for reduced herd effect due to
  loss of infectious individuals via turnover to increase prevalence,
  whereas reduced herd effect due to loss of treated/immune individuals
  can and does increase prevalence due to re-supply of infectious individuals.
  % JK: @SM, I forgot this important detail in my rough thoughts in the email.
  %     The treated group really is fundamental to the trends we have observed here
  %     (for better or for worse!)
  To clarify this point, we've also added to the discussion:
  \quote{%
  ...
  but we did not call the simulated infection ``HIV'' since we did not model infection-attributable mortality.
  % JK: @SM, not sure if you feel this is relevant, but I feel it helps contextualize our decisions.
  We note in the methods (\S~2.2) how the infection could also represent hepatitis B virus,
  and indeed we think our insights may be useful for a variety of non-STI pathogens
  where risk heterogeneity is present, many of which may have at least temporary/treatment-induced immunity.
  ...
  %     (last sentence in the limitations section). What do you think?
}
% --------------------------------------------------------------------------------------------------
\comment{%
...
\reply{%
  In the discussion, we have added the following details to help clarify the types of interventions
  which may be most affected by the insights from the paper:
  \quote{%
    ...
    \added{Such needs may be addressed by interventions tailored to
