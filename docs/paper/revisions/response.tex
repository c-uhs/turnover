...
\reply{%
  ...
  The ``treated'' group are mechanistically considered an ``immune'' group. That is, once individuals in the infectious state receive treatment,
...
\reply{%
  ...
  would depend on the rate of turnover. Similarly, while the contribution of the medium risk group to onward transmission could
  increase relative to the low risk group, the contribution could decrease relative to the high risk group.  %SM: avoid adjectives like "actually", etc. - makes the tone a bit aggressive. just be objective :). 

  \par
   Thus we have included a recommendation for further study, and added the following in the revised manuscript to address the comment.  %SM: can we add to discussion re: future study?
  Results 3.1:
  \quote{%
  ...
  % SM: yes, that makes sense! I would add a line in the limitations section or future research section re: future research/work to examine mechanisms within other risk-strata such as the medium risk group.
}
% --------------------------------------------------------------------------------------------------
\comment{%
