...
% SM: most prefer active voice (will forward a great tweet by Bill Miller I think),
%     but note that Stef suggested passive voice ha ha :) am ok with that for now because rest of para is active.
% JK: Cool! But then I think one passive sentence sounds out of place, no?
%     I prefer active too, so will change it back, sorry Stef!
