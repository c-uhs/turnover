...
From Figure~\ref{fig:flows} shows
that the proportion of individuals 
who are infectious state is largest in the high risk group 
at all four rates of turnover. Therefore, as
individuals in the infectious state leave 
the high risk group via turnover, they were largely 
replaced by susceptible individuals from lower risk groups. 				%SM: refer here to Figure 7b in Appendix so that the "numbers" can be corroborated.
