...
first in the smallest high risk group, and then in the largest low risk group.
...
\begin{figure}[!tbp]
  \centerline{\includegraphics[width=0.5\linewidth]{main-tpaf-tpaf-high-all-vs=fit.pdf}}
