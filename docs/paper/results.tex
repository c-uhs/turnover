...
%SM: Figure 4 and Figure 5. (and appendix figures). make it clear that 0.03 = no turnover in the caption. Figures should be stand-alone and 'no turnover' is not clear at all when reading those figures without the main text. 
...
reduced STI prevalence within the high risk group (Figure X). 
At the same time, 
