...
In this section we summarize the results of the experiments described above.
...
on incidence and prevalence, with focus on systems at equilibrium.
% --------------------------------------------------------------------------------------------------
...
$\input{\datapath/fit/Base-prevalence-ratio.txt}$ with turnover, and 
...
($\input{\datapath/fit/Base-fit-C-ratio.txt}$)
