...
\node(i1) [tbox=\colori, left  = 2cm of x1] {$e_1$};
\node(i2) [tbox=\colori, left  = 2cm of x2] {$e_2$};
\node(i3) [tbox=\colori, left  = 2cm of x3] {$e_3$};
\node(o1) [tbox=white,   right = 2cm of x1] {};
\node(o2) [tbox=white,   right = 2cm of x2] {};
\node(o3) [tbox=white,   right = 2cm of x3] {};
...
\draw[arrow=\coloro] (x1) edge["$\mu$", near end]   (o1);
\draw[arrow=\coloro] (x2) edge["$\mu$", near end]   (o2);
\draw[arrow=\coloro] (x3) edge["$\mu$", near end]   (o3);
