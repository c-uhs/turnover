...
and the relative size of the risk group; %SM: cite original PAF description = Levin 1953 or Hanley PMID: 11413183
...
of STI infections - contribution is interpreted as 5 percent of the population contributing to  %cite: e.g. classic PAF due to sex work. PMID 23717432. https://www.ncbi.nlm.nih.gov/pubmed/23717432
...
% SM: Not really accurate :) --> the PAF is different from the tPAF but *not just because of time-period*.. PAF is generated from observational data and does not account for indirect/onward/secondary transmission. The MOT modeled esiimates come from a binomial probablity term to generate incident estimates, not traditional PAF equations per se which work with empirical prevalent or incident estiamtes. 
